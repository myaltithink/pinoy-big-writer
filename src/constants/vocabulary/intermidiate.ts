...
const setH: QuizQuestion[] = [{
        type: QuestionType.Direction,
        direction: "Answer and complete the following items. You have 25 seconds to answer each one. Get 7 correct answers to complete the level successfully.",
        question: "",
        explanation: '',
        correctAnswer: "",
    },
...
export const VOCAB_INTERMIDIATE_SET: SetContainer[] = [{
        ...
        metadata: metadata,
        set: {
            instruction: "Answer and complete the following items. You have 25 seconds to answer each one. Get 7 correct answers to complete the level successfully. ",
            questions: setA,
        }
    },
    {
