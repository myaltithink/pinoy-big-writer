...
function Capitalization() {
  ...
  return (
    <div className="min-h-screen flex flex-col gap-8 items-center justify-around bg-white p-4 font-sans capitalization">
      {/* Title */}
      <motion.div
        className="flex justify-center bg-yellow-500 px-6 py-3 rounded-xl"
        ...
        {levels?.map((completed, idx) => {
          ...
          const levelContent = (
            ...
            >
              ...
              {unlocked && (
                <span className="text-center text-3xl text-yellow-500 font-semibold break-words">
                  {levelsName[idx]}
                </span>
              )}
            </motion.div>
